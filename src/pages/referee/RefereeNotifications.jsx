...
import { Bell, CheckCircle2, Trophy, ClipboardList, Loader2, ShieldCheck } from 'lucide-react';
        ...
        <div className="divide-y divide-gray-100 flex-1">
          {loading ? (
            ...
            <div className="py-20 text-center text-gray-400 space-y-2">
              ...
              <h3 className="text-base font-extrabold text-gray-800">No Officiating Alerts Yet</h3>
              <p className="text-xs text-gray-500">When organizers assign matches or announce tournaments, alerts will show here.</p>
            </div>
          ) : (
            notifications.map(n => {
              ...
              return (
                ...
                >
                  <div className={`w-11 h-11 rounded-2xl flex items-center justify-center shrink-0 shadow-inner ${
                    n.type === 'REFEREE' || n.type === 'MATCH' ? 'bg-purple-100 text-purple-700' :
                    n.type === 'TOURNAMENT' ? 'bg-emerald-100 text-[#08733e]' :
                    'bg-gray-100 text-gray-700'
                  }`}>
                    {n.type === 'REFEREE' || n.type === 'MATCH' ? <ClipboardList size={20} /> : <Trophy size={20} />}
                  </div>

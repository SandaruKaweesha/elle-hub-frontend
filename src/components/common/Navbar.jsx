  ...
  return (
    <nav className="relative w-full h-16 md:h-[68px] border-b border-[#d6d8d4] bg-[#f8f7f4] z-50">
      <div className="w-full h-full px-4 md:px-[60px] flex items-center justify-between">
        ...
        {/* Mobile Menu Button */}
        <button 
          className="md:hidden flex items-center justify-center p-2 text-[#111111] cursor-pointer"
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-[#f8f7f4] border-b border-[#d6d8d4] flex flex-col items-center py-8 gap-6 md:hidden shadow-xl z-50">
